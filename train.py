...
hist_b = train_model(baseline, train_loader, opt_b, criterion,
                     EPOCHS_BASELINE, label="Baseline")
...
hist_r = train_model(resnet, train_loader, opt_r, criterion,
                     EPOCHS_FINETUNE, label="ResNet50")
